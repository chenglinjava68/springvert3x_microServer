 ...
 */
@Component
public class ResumeDetailVerticle extends AbstractVerticle {

    private static final Logger LOGGER = LoggerFactory.getLogger(ResumeDetailVerticle.class);

    public void start() {
        vertx.eventBus().consumer("resumedetail", message -> {
