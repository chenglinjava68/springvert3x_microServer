 ...
 */
@Component
public class ResumeVerticle extends AbstractVerticle {

    private static final Logger LOGGER = LoggerFactory.getLogger(ResumeVerticle.class);

    public void start() {
        vertx.eventBus().consumer("resume", message -> {
