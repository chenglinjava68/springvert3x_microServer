 ...
 */
@Component
public class RouteToVerticle extends AbstractVerticle {
    private static final Logger LOGGER = LoggerFactory.getLogger(RouteToVerticle.class);

    @Autowired
    private RouteService routeService;

    public void start() {
        vertx.eventBus().consumer("to", message -> {
            ...
            try {
                ...
                GetPoiListResp response = routeService.to(obj.getParam());
