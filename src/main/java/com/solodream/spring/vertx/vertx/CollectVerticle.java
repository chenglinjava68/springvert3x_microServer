 ...
 */
@Component
public class CollectVerticle extends AbstractVerticle {

    private static final Logger LOGGER = LoggerFactory.getLogger(CollectVerticle.class);

    public void start() {
        vertx.eventBus().consumer("collect", message -> {
