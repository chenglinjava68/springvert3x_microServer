 ...
 */
@Component
public class UserFavoritesVerticle extends AbstractVerticle {
    private static final Logger LOGGER = LoggerFactory.getLogger(UserFavoritesVerticle.class);

    public void start() {
        vertx.eventBus().consumer("favorites", message -> {
